...
int main() {
  ...
  assert(binarySearch(list, 543) == 8);
  assert(binarySearch(list, 4) == 2);
  assert(binarySearch(list, 124) != 8);
  assert(binarySearch(list, 564) != 10);
  assert(binarySearch(list, 800) != 0);
  assert(binarySearch(list, 6000) != 5);
  assert(binarySearch(list, 124) == 6);
  assert(binarySearch(list, 564) == 9);
  assert(binarySearch(list, 800) == -1);
  assert(binarySearch(list, 6000) == -1);
  assert(linearSearch(list, 87) == 4);
  assert(linearSearch(list, 0) == 0);
  assert(linearSearch(list, 234) == 7);
  assert(linearSearch(list, 235) == -1);
  return 0;
}
