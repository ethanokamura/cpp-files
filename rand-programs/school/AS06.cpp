 ...
 * @version 0.1
  ...
  ie: A = 0, B = 1, C = 2, Z = 25
  The keyword is broken down letter by letter and its value is repeated for each letter in the secret phrase
  Keyword: ABC ( 0 1 2 ) <- shifting value
  Phrase: HelloWorld
  Encrypted Phrase: HFNLPYOSND ( 0 1 2 0 1 2 0 1 2 0 ) <- amount to shift each letter
